  ...
  return (
    <div>
      <div className='search'>
        ...
        />
        <button id="searchButton" onClick={handleSearchSubmit}>Search</button>
      </div>
      ...
      <div id="container">
        {modal.isOpen && (
          <div className="modal" style={{ display: 'block' }}>
            ...
            <img className="modal-content" id="img01" src={modal.src} alt={modal.alt} style={{ backgroundColor: 'transparent', borderColor: 'transparent' }} />
